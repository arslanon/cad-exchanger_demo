  ...
  constructor() {
    temperatureLevelStateConfig.forEach((state: TemperatureLevelStateModel) => {
      ...
      state.appearance = new cadex.ModelData_Appearance(
        ...
        // cadex.ModelData_ColorObject.fromHex('FF0000')
        // new cadex.ModelData_ColorObject(state.color.red / 255, state.color.green / 255, state.color.blue / 255, 1)
      );
    });
  }

  // appearanceMaterial = new cadex.ModelData_Appearance(
  //   new cadex.ModelData_MaterialObject(
